...
public class AnalyzerDriver {
     ...
     *
     * @param arguments The input file path for the text file that will be analyzed and
    ...
    public static void main(String[] arguments) {
        ...
        System.out.println("Your file is being analyzed. Please be patient you entered a large file.");
