        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">                   
                    <h2>Data from the Project 3 Properties file</h2                        
                </div>
            </div>
        </div>
    </section>
    ...
    <div>
        <table class="tbView">
            ...
            <tr class="tbRow">
                ...
                <td>${project3Properties.email}</td>
                <td>${project3Properties.course}</td>
                <td>${project3Properties.section}</td>
                <td>${project3Properties.instructor}</td>
                <td>${project3Properties.description}</td>
            </tr>
