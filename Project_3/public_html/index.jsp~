        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <h2 class="section-heading">Welcome to SeanFiscus.com</h2>
                    <hr class="light">
                    <p class="text-faded">
                        I recently entered the IT realm and will never leave. I'm currently pursuing a degree in
                        Mobile Applications and am fascinated by all things IT and programming. One of the things I
                        love the most about this field is the constant state of change. It is impossible to truly know
                        everything. All one can do is constantly educate themselves, which is what I intend to do. This
                        website alone is proof of that. Again, thank you for stopping by and direct any questions you
                        may have in the contact section below.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="no-padding" id="portfolio">
        <div class="container-fluid">
            <div class="row no-gutter">
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="linkingDemo2.html" class="portfolio-box">
